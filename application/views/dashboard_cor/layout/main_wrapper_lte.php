	...
	<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="wrapper">
			<header class="main-header">
				...
				<a href="<?php echo base_url('dashboard_cor/dashboard_cor/index') ?>" class="logo" style="padding: 0px">
					<!-- mini logo for sidebar mini 50x50 pixels -->
					<span class="logo-mini"><img src="<?= base_url('siteassets/cluster_logo_min.png') ?>" alt="Logo"></span>
					<!-- logo for regular state and mobile devices -->
					<span class="logo-lg"><img src="<?= base_url('siteassets/cluster_logo.png') ?>" alt="Logo"></span>
				</a>
					  ...
					  <li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
						  ...
						  <li class="user-header">
							...
							<p>
							  <?php echo $this->session->userdata('fullname') ?> - Coodinator
						  ...
						  <li class="user-footer">
							<div class="btn-group btn-group-justified">
							  <a href="<?php echo base_url('dashboard_cor/dashboard_cor/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
				...
				<section class="sidebar">
				  ...
				  <ul class="sidebar-menu" data-widget="tree">
					...
					<li class="<?php echo (($this->uri->segment(1) == 'dashboard') && (($this->uri->segment(2) == 'index')) ? "active" : null) ?>"> <!-- Dashboard -->
					  <a href="<?php echo base_url('dashboard_cor/dashboard_cor/index') ?>">
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "center") ? "active" : null) ?>">
					  ...
					  <ul class="treeview-menu"> 
					      <li>
							<a href="<?php echo base_url("dashboard_cor/center/create") ?>">
					      ...
					      <li><a href="<?php echo base_url("dashboard_cor/center") ?>">
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "material") ? "active" : null) ?>">
					  ...
					  <ul class="treeview-menu">
						  <li><a href="<?php echo base_url("dashboard_cor/material/create") ?>">
								<i <?php echo (($this->uri->segment(2) == "material") && ($this->uri->segment(3) == "create") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('add_material') ?></a>
						  </li>
					      <li><a href="<?php echo base_url("dashboard_cor/material/index") ?>">
								<i <?php echo (($this->uri->segment(2) == "material") && ( ($this->uri->segment(3) == "index") || ($this->uri->segment(3) == "")) ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('view_material') ?></a>
						  </li>
					  </ul>
					</li>
					<!--############################## User ##############################-->
					<li class="treeview <?php echo (($this->uri->segment(2) == "user") ? "active" : null) ?>">
					  ...
					  <ul class="treeview-menu"> 
					      <li>
							<a href="<?php echo base_url("dashboard_cor/user/create_student") ?>">
					      ...
					      <li><a href="<?php echo base_url("dashboard_cor/user/index") ?>">
						  ...
						  <li>
							<a href="<?php echo base_url("dashboard_cor/user/create_member") ?>">
					      ...
					      <li><a href="<?php echo base_url("dashboard_cor/user/members") ?>">
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "message") ? "active" : null) ?>">
					  <a href="#">
					      <i class="fa fa-pencil-square-o"></i> <span><?php echo display('message') ?></span>
					      <span class="pull-right-container">
					          <i class="fa fa-angle-left pull-right"></i>
					      </span>
					  </a>
					  <ul class="treeview-menu">
					      <li><a href="<?php echo base_url("dashboard_cor/message/new_message") ?>">
								<i <?php echo (($this->uri->segment(2) == "message") && ($this->uri->segment(3) == "new_message") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('new_message') ?></a>
						  </li>
					      <li><a href="<?php echo base_url("dashboard_cor/message/") ?>">
								...
								<?php echo display('inbox') ?></a>
						  </li> 
					      <li><a href="<?php echo base_url("dashboard_cor/message/sent") ?>">
								...
								<?php echo display('sent') ?></a>
						  </li>
					  </ul>
					</li>
					<!--############################## Settings ##############################-->
					<?php /* <li class="treeview <?php echo (($this->uri->segment(1) == "setting" || ($this->uri->segment(1) == "dashboard_cor/dashboard_cfo" && $this->uri->segment(2) == "profile") || $this->uri->segment(1) == "language") ? "active" : null) ?>" > <!-- Settings -->
					  <a href="#">
					  ...
					  <ul class="treeview-menu"> 
						...
						<li><a href="<?php echo base_url("dashboard_cor/dashboard_cfo/profile") ?>">
							<i <?php echo (($this->uri->segment(1) == "dashboard_cor" && $this->uri->segment(2) == "profile") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i> 
