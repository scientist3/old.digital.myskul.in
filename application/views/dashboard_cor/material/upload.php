    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_cor/material") ?>"> <i class="fa fa-list"></i>  <?php echo display('view_material') ?> </a>  
                </div>
            </div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
					...
					<div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_cor/material/create','class="form-inner" id="mailForm"') ?>
...
$(function(){
    ...
    browseFile.on('change',function(e)
    {
        ...
        $.ajax({
            url      : '<?php echo base_url('dashboard_cor/material/do_upload') ?>',
    ...
    $("#cluster_idd").change(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_cor/material/center_by_cluster/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
