        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_cor/user/create_student") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_student') ?> </a>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_cor/user/create_member','class="form-inner"') ?>
