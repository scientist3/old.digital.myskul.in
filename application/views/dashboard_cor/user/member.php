        ...
        <div  class="panel panel-default thumbnail">
            <div class="panel-heading no-print">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group "> 
                            <a class="btn btn-success" href="<?php echo base_url("dashboard_cor/user/create_member") ?>"> 
                                <i class="fa fa-plus"></i>  <?php echo display('add_member') ?> 
                            </a>
                            <a class="btn btn-info" href="<?php echo base_url("dashboard_cor/user/create_student") ?>"> 
                                <i class="fa fa-plus"></i>  <?php echo display('add_student') ?> 
                            </a>
                            <a class="btn btn-info" href="<?php echo base_url("dashboard_cor/user/index") ?>"> 
                            ...
                            <?php foreach ($users as $user) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td style="width:90px !important;">
                                        <a href="<?php echo base_url("dashboard_cor/user/user_profile/$user->user_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                        <a href="<?php echo base_url("dashboard_cor/user/user_edit/$user->user_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("dashboard_cor/user/user_delete/$user->user_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a> 
                                    </td>
