    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_cor/user") ?>"> <i class="fa fa-list"></i>  <?php echo display('list_student') ?> </a>
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_cor/user/create_member") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_member') ?> </a>
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_cor/user/members") ?>"> <i class="fa fa-list"></i>  <?php echo display('list_user') ?> </a>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_cor/user/create_student','class="form-inner"') ?>
...
$(function(){
    ...
    $("#cluster_idd").change(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_cor/user/center_by_cluster/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
