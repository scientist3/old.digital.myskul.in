    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_cor/center/create") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_center') ?> </a>
                </div>
            </div>
                            ...
                            <?php foreach ($centers as $center) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?php echo base_url("dashboard_cor/center/edit/$center->center_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("dashboard_cor/center/delete/$center->center_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
