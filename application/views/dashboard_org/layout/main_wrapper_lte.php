				...
				<section class="sidebar">
				  ...
				  <ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "userlog") ? "active" : null) ?>">
					  <a href="#">
					      <i class="fa fa-file-pdf-o"></i> <span><?php echo display('attendance_report') ?></span>
					      <span class="pull-right-container">
					          <i class="fa fa-angle-left pull-right"></i>
					      </span>
					  </a>
					  <ul class="treeview-menu">
						  	<li><a href="<?php echo base_url("dashboard_org/userlog/index") ?>">
								<i <?php echo (($this->uri->segment(2) == "userlog") && ($this->uri->segment(3) == "index") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('attendance_by_r_c_c') ?></a>
						  	</li>
					       	<li><a href="<?php echo base_url("dashboard_org/userlog/absent") ?>">
								<i <?php echo (($this->uri->segment(2) == "userlog") && ( ($this->uri->segment(3) == "absent") || ($this->uri->segment(3) == "")) ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('absentee_report') ?></a>
						  	</li>
					  </ul>
					</li>
					<!--############################## Cluster ##############################-->
					<li class="treeview <?php echo (($this->uri->segment(2) == "cluster") ? "active" : null) ?>">
					  ...
					  <ul class="treeview-menu">
						  ...
						  <li><a href="<?php echo base_url("dashboard_org/cluster/statistics") ?>">
								<i <?php echo (($this->uri->segment(2) == "cluster") && ($this->uri->segment(3) == "statistics") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('statistics') ?></a>
						  </li>
