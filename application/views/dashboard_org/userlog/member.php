		...
		<div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('dashboard_org/userlog/index') ?>" method="post" class="">
                            ...
                            <?php foreach ($users as $user) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td style="width:90px !important;">
                                        <a href="<?php echo base_url("dashboard_org/userlog/view/$user->user_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
