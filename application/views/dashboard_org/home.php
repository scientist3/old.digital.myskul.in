		  <div class="row">
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-light-blue">
				<div class="inner">
				  <h3><?php echo !empty($total_logedin_today)?$total_logedin_today:'0';?></h3>
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-maroon">
				<div class="inner">
				  <h3><?php echo !empty($total_cor_logedin)?$total_cor_logedin:'0';?></h3>
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-teal">
				<div class="inner">
				  <h3><?php echo !empty($total_ani_logedin)?$total_ani_logedin:'0';?></h3>
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-navy-active">
				<div class="inner">
				  <h3><?php echo !empty($total_std_logedin)?$total_std_logedin:'0';?></h3>

				  <p>Total <?php echo display("student"); ?> Loggedin</p>
				</div>
				<div class="icon">
				  <i class="ion ion-android-contacts"></i>
				</div>
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-light-blue" style="background-color: #52b8f4 !important;">
				<div class="inner">
				  <h3><?php echo !empty($total_absentee_today)?$total_absentee_today:'0';?></h3>
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-maroon" style="background-color: #ff2172 !important;">
				<div class="inner">
				  <h3><?php echo !empty($total_cor_absentee)?$total_cor_absentee:'0';?></h3>
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-teal" style="background-color: #45e7e7  !important;">
				<div class="inner">
				  <h3><?php echo !empty($total_ani_absentee)?$total_ani_absentee:'0';?></h3>
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="small-box bg-navy-active" style="background-color: #002b57 !important;">
				<div class="inner">
				  <h3><?php echo !empty($total_std_absentee)?$total_std_absentee:'0';?></h3>

				  <p>Total <?php echo display("student"); ?> Absent</p>
				</div>
				<div class="icon">
				  <i class="ion ion-android-contacts"></i>
				</div>
