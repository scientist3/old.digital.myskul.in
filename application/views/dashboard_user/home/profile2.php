          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="settings">
                <!--<form class="form-horizontal">-->
                  <?php echo form_open_multipart('dashboard_incharge/home/form/','class="form-horizontal"') ?> 
                  ...
                  <div class="form-group">
                      <label for="district" class="col-sm-2 control-label"><?php echo display('district') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <?php
                                            //''  => "Select District",
                                        $district_list = array(
                                        ...
                                        echo form_dropdown('district', $district_list, $user->district, 'class="form-control" id="district" ');
