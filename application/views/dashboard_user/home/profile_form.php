    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_incharge/home/form") ?>"> <i class="fa fa-list"></i>  <?php echo display('profile') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_incharge/home/form/','class="form-inner"') ?> 
                                  ...
                                  <label for="district" class="col-xs-3 col-form-label"><?php echo display('district') ?> <i class="text-danger">*</i></label>
                                    <div class="col-xs-9">
                                        <?php
                                            ...
                                            echo form_dropdown('district', $district_list, $doctor->district, 'class="form-control" id="district" ');
