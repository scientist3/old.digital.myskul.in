    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            <div class="panel-heading">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_nadu/messages/message/new_message") ?>"> <i class="fa fa-send-o"></i>  <?php echo display('new_message') ?> </a>
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_nadu/messages/message") ?>"> <i class="fa fa-inbox"></i>  <?php echo display('inbox') ?> </a> 
                </div> 
            </div>
                            ...
                            <?php foreach ($messages as $message) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?php echo base_url("dashboard_nadu/messages/message/sent_information/$message->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>  
