    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_ani/material/create") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_material') ?> </a> 
                </div>
            </div>
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('org_name') ?></th> 
                            ...
                            <?php foreach ($materials as $material) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        ...
                                        <a href="<?php echo base_url("dashboard_ani/material/view/$material->mat_id") ?>" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a> 
                                        <a href="<?php echo base_url("dashboard_ani/material/edit/$material->mat_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("dashboard_ani/material/delete/$material->mat_id?isfile=".(($material->mat_type==2)?1:0)."&file=$material->mat_doc_link") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
