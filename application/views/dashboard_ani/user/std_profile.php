    ...
    <div class="col-sm-12" id="PrintMe">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_ani/user/create_student") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_student') ?> </a>  
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_ani/user") ?>"> <i class="fa fa-list"></i>  <?php echo display('list_student') ?> </a>  
