                ...
                <div class="row">
                    ...
                    <div class="btn-group "> 
                            <a class="btn btn-info" href="<?php echo base_url("dashboard_ani/activities/cncp_enrolled_new") ?>"> 
                                <i class="fa fa-plus"></i>  Add New Child<?php //echo display('add_student') ?> 
                            </a>
                        </div>    
					<div class="btn-group "> 
                            <a class="btn btn-info" href="<?php echo base_url("dashboard_ani/activities/cncp_enrolled_new") ?>"> 
                                <i class="fa fa-plus"></i>  Enroll for CNCP From Existing List<?php //echo display('add_student') ?> 
                            </a>
                        </div>
                            ...
                            <?php foreach ($users as $user) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td style="width:90px !important;">
                                        <a href="<?php echo base_url("dashboard_ani/user/stdprofile/$user->user_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                        <a href="<?php echo base_url("dashboard_ani/user/stdedit/$user->user_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("dashboard_ani/user/stddelete/$user->user_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a> 
                                    </td>
