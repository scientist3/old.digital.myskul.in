            ...
            <div class="col-md-3">                
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo !empty($student->picture)?base_url($student->picture):base_url('siteassets/images/no_image.png'); ?>" alt="User profile picture">
