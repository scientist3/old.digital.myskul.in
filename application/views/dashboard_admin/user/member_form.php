    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_admin/user/members") ?>"> <i class="fa fa-list"></i>  <?php echo display('list_user') ?> </a>
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_admin/user/create_student") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_student') ?> </a>
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_admin/user") ?>"> <i class="fa fa-list"></i>  <?php echo display('list_student') ?> </a>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_admin/user/create_member','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="user_role" class="col-xs-3 col-form-label"><?php echo display('user_role') ?>     </label>
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('user_role', $user_role_list, $student->user_role, 'class="form-control" id="user_role" '); ?>
                                </div>
                            </div>
