        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    ...
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_admin/user/create_member") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_member') ?> </a>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_admin/user/create_student','class="form-inner"') ?>
