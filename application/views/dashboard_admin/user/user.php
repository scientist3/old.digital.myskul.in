                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group "> 
                            ...
                            <a class="btn btn-success" href="<?php echo base_url("dashboard_admin/user/members") ?>"> 
                            ...
                            <?php foreach ($users as $user) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td style="width:90px !important;">
                                        <a href="<?php echo base_url("dashboard_admin/user/stdprofile/$user->user_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                        <a href="<?php echo base_url("dashboard_admin/user/stdedit/$user->user_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("dashboard_admin/user/stddelete/$user->user_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a> 
                                    </td>
