...
<html lang="en">
    <head>
		...
		<!-- New Date time picker CSS -->
		<!-- <link rel="stylesheet" href="<?php echo base_url('assetslte/'); ?>plugins/newdatetimepicker/bootstrap-datetimepicker.css"> -->
	...
	<body class="hold-transition sidebar-mini skin-black fixed">
		<!-- Site wrapper -->
		<div class="wrapper">
			<header class="main-header">
				<!-- Logo -->
				<?php $logo = $this->session->userdata('logo'); ?>
				<a href="<?php echo base_url('dashboard_admin/dashboard_cfo/index') ?>" class="logo" style="padding:0px;">
					<!-- mini logo for sidebar mini 50x50 pixels -->
					<span class="logo-mini"><img src="<?= base_url('siteassets/admin_logo_min.png') ?>" alt="Logo" style="width: 68%;"></span>
					<!-- logo for regular state and mobile devices -->
					<span class="logo-lg"><img src="<?= base_url('siteassets/admin_logo.png') ?>" alt="Logo" style="width: 100%;"></span>
				</a>
						...
						<ul class="dropdown-menu">
						  ...
						  <li class="user-footer">
							<div class="btn-group btn-group-justified">
							  <a href="<?php echo base_url('dashboard_admin/dashboard_cfo/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
				  ...
				  <ul class="sidebar-menu" data-widget="tree">
					...
					<li class="<?php echo (($this->uri->segment(1) == 'dashboard') && (($this->uri->segment(2) == 'index')) ? "active" : null) ?>"> <!-- Dashboard -->
					  <a href="<?php echo base_url('dashboard_admin/dashboard_cfo/index') ?>">
					...
					<!--############################## Organisation ##############################-->
					<li class="treeview <?php echo (($this->uri->segment(2) == "organisation") ? "active" : null) ?>">
					  <a href="#">
					      <i class="fa fa-file-pdf-o"></i> <span><?php echo display('organisation') ?></span>
					      <span class="pull-right-container">
					          <i class="fa fa-angle-left pull-right"></i>
					      </span>
					  </a>
					  <ul class="treeview-menu">
					      <li><a href="<?php echo base_url("dashboard_admin/organisation/create") ?>">
								<i <?php echo (($this->uri->segment(2) == "organisation") && ($this->uri->segment(3) == "create") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('add_org') ?></a>
						  </li>
					      <li><a href="<?php echo base_url("dashboard_admin/organisation") ?>">
								<i <?php echo (($this->uri->segment(2) == "organisation") && ($this->uri->segment(3) == "") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('list_org') ?></a>
						  </li> 
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "cluster") ? "active" : null) ?>">
					  <a href="#">
					      <i class="fa fa-file-pdf-o"></i> <span><?php echo display('cluster') ?></span>
					      <span class="pull-right-container">
					          <i class="fa fa-angle-left pull-right"></i>
					      </span>
					  </a>
					  <ul class="treeview-menu">
					      <li><a href="<?php echo base_url("dashboard_admin/cluster/create") ?>">
								<i <?php echo (($this->uri->segment(2) == "cluster") && ($this->uri->segment(3) == "create") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('add_cluster') ?></a>
						  </li>
					      <li><a href="<?php echo base_url("dashboard_admin/cluster") ?>">
								<i <?php echo (($this->uri->segment(2) == "cluster") && ($this->uri->segment(3) == "") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('list_cluster') ?></a>
						  </li> 
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "center") ? "active" : null) ?>">
					  ...
					  <ul class="treeview-menu"> 
					      <li>
							<a href="<?php echo base_url("dashboard_admin/center/create") ?>">
								<i <?php echo (($this->uri->segment(2) == "center") && ($this->uri->segment(3) == "create") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('add_center') ?>
							</a>
						  </li>
					      <li><a href="<?php echo base_url("dashboard_admin/center") ?>">
							<i <?php echo (($this->uri->segment(2) == "center") && ($this->uri->segment(3) == "") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('list_center') ?></a>
						  </li> 
					      
					  </ul>
					</li>
					<!--############################## Material ##############################-->
					<li class="treeview <?php echo (($this->uri->segment(1) == "material") ? "active" : null) ?>">
					  <a href="#">
					      <i class="fa fa-file-pdf-o"></i> <span><?php echo display('material') ?></span>
					      <span class="pull-right-container">
					          <i class="fa fa-angle-left pull-right"></i>
					      </span>
					  </a>
					  <ul class="treeview-menu">
						  <li><a href="<?php echo base_url("material/create") ?>">
								<i <?php echo (($this->uri->segment(1) == "material") && ($this->uri->segment(2) == "create") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('add_material') ?></a>
						  </li>
					      <li><a href="<?php echo base_url("material/index") ?>">
								<i <?php echo (($this->uri->segment(1) == "material") && ( ($this->uri->segment(2) == "index") || ($this->uri->segment(2) == "")) ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('view_material') ?></a>
						  </li>
					  </ul>
					</li>
					<!--############################## User ##############################-->
					<li class="treeview <?php echo (($this->uri->segment(2) == "user") ? "active" : null) ?>">
					  <a href="#">
					      <i class="fa fa-wheelchair"></i> <span><?php echo display('user') ?></span>
					      <span class="pull-right-container">
					          <i class="fa fa-angle-left pull-right"></i>
					      </span>
					  </a>
					  <ul class="treeview-menu"> 
					      <li>
							<a href="<?php echo base_url("dashboard_admin/user/create_student") ?>">
					      ...
					      <li><a href="<?php echo base_url("dashboard_admin/user/index") ?>">
							<i <?php echo (($this->uri->segment(2) == "user") && ($this->uri->segment(3) == "") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i>
							<?php echo display('list_student') ?></a>
						  </li> 
						  <li>
							<a href="<?php echo base_url("dashboard_admin/user/create_member") ?>">
					      ...
					      <li><a href="<?php echo base_url("dashboard_admin/user/members") ?>">
					...
					<!--############################## Settings ##############################-->
					<li class="treeview <?php echo (($this->uri->segment(1) == "setting" || ($this->uri->segment(1) == "dashboard_admin/dashboard_cfo" && $this->uri->segment(2) == "profile") || $this->uri->segment(1) == "language") ? "active" : null) ?>" > <!-- Settings -->
					  <a href="#">
					  ...
					  <ul class="treeview-menu"> 
						...
						<li><a href="<?php echo base_url("dashboard_admin/dashboard_cfo/profile") ?>">
							<i <?php echo (($this->uri->segment(1) == "dashboard_admin" && $this->uri->segment(2) == "profile") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i> 
		...
		<div>
			...
			<!--  New Datetime Picker  -->
			<!-- <script src="<?php echo base_url('assetslte/') ?>plugins/newdatetimepicker/bootstrap-datetimepicker.js" type="text/javascript"></script>
			<script src="<?php echo base_url('assetslte/') ?>plugins/newdatetimepicker/moment-with-locales.js" type="text/javascript"></script>
			 -->
			<script>
				"use strict";
