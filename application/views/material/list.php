                            ...
                            <?php foreach ($materials as $material) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        ...
                                        <a href="<?php echo base_url("material/view/$material->mat_id") ?>" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a> 
                                        <a href="<?php echo base_url("material/edit/$material->mat_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("material/delete/$material->mat_id?isfile=".(($material->mat_type==2)?1:0)."&file=$material->mat_doc_link") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
