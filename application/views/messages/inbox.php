                    ...
                    <tbody>
                        <?php if (!empty($messages)) { ?>
                            ...
                            <?php foreach ($messages as $message) { ?>
                                <tr>
                                    <!-- <td><?php echo $sl; ?></td> -->
                                    <td><a href="<?php echo base_url("messages/message/index/$message->sender_id") ?>" class=""><?php echo $message->sender_name; ?></a></td>
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?php echo base_url("messages/message/inbox_information/$message->id/$message->sender_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
