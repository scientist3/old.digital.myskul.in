				...
				<div class="col-sm-12">
					<div class="panel panel-default thumbnail">
						<div class="panel-heading">
								<div class="btn-group "> 
										<a class="btn btn-primary" href="<?php echo base_url("dashboard_std/material") ?>"> <i class="fa fa-list"></i>  <?php echo display('view_material') ?> </a> 
								</div>
									...
									<?php }else{ ?>
										<li>
											...
											<div class="timeline-item">
												...
												<div class="timeline-footer">
													<a href="<?php echo base_url(); ?>dashboard_std/material/download/<?php echo $material->mat_doc_link ?>"class="btn btn-default btn-xs">
