	...
	<body class="hold-transition sidebar-mini skin-black fixed">
		...
		<div class="wrapper">
			<header class="main-header">
				...
				<a href="<?php echo base_url('dashboard_std/dashboard_std/index') ?>" class="logo" style="padding:0px;">
					<!-- mini logo for sidebar mini 50x50 pixels -->
					<span class="logo-mini"><img src="<?= base_url('siteassets/std_logo_min.png') ?>" alt="Logo" style="width: 68%;"></span>
					<!-- logo for regular state and mobile devices -->
					<span class="logo-lg"><img src="<?= base_url('siteassets/std_logo.png') ?>" alt="Logo" style="width: 100%;"></span>
				</a>
						...
						<ul class="dropdown-menu">
						  ...
						  <li class="user-footer">
							<div class="btn-group btn-group-justified">
							  <a href="<?php echo base_url('dashboard_std/dashboard_std/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
				...
				<section class="sidebar">
				  ...
				  <ul class="sidebar-menu" data-widget="tree">
					...
					<li class="<?php echo (($this->uri->segment(1) == 'dashboard') && (($this->uri->segment(2) == 'index')) ? "active" : null) ?>"> <!-- Dashboard -->
					  <a href="<?php echo base_url('dashboard_std/dashboard_std/index') ?>">
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "material") ? "active" : null) ?>">
					  ...
					  <ul class="treeview-menu">
					      <li><a href="<?php echo base_url("dashboard_std/material/index") ?>">
								<i <?php echo (($this->uri->segment(2) == "material") && ($this->uri->segment(3) == "index") ? 'class="fa fa-circle" style="color: chartreuse;"' : 'class="fa fa-circle-o"') ?>></i><?php echo display('view_material') ?></a>
						  </li>					      
					  </ul>
					</li>
					...
					<li class="treeview <?php echo (($this->uri->segment(2) == "message") ? "active" : null) ?>">
					  ...
					  <ul class="treeview-menu">
					      <li><a href="<?php echo base_url("dashboard_std/message/new_message") ?>">
					      ...
					      <li><a href="<?php echo base_url("dashboard_std/message/") ?>">
					      ...
					      <li><a href="<?php echo base_url("dashboard_std//message/sent") ?>">
