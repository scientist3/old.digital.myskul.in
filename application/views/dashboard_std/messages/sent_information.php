        ...
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    ...
                    <a class="btn btn-info" href="<?php echo base_url("dashboard_std/message/sent") ?>"> <i class="fa fa-share"></i>  <?php echo display('sent') ?> </a>
					<a class="btn btn-info" href="<?php echo base_url("dashboard_std/message/reply/".$message->receiver_id) ?>"> <i class="fa fa-share"></i>  <?php echo 'Reply' ?> </a>
