...
<div class="login-box">
  ...
  <div class="login-logo">
    <!--<a href="<?php echo base_url(); ?>"> <img src="<?php echo (!empty($logo)?base_url($logo):base_url("assets/images/logo.png")) ?>" alt="Logo">--></a>
  </div>
  <!-- /.login-logo -->
  
  <div class="login-box-body" style="display: block;box-sizing: border-box;">
	<a href="<?php echo base_url(); ?>"> <img style="margin: auto 5%;" src="<?php echo base_url('assetslte/images/logo.png');//echo (!empty($logo)?base_url($logo):base_url("assets/images/logo.png")) ?>" alt="Logo"></a>
	<h3>
		<p class="login-box-msg"><?php echo (!empty($title)?$title:null) ?></p>
		<h4 class="text-center text-green">Patient Login</h4>
	</h3>
    ...
    <?php echo form_open('user/login','id="loginForm" novalidate'); ?>
		<div class="form-group has-feedback">
			<input type="patient_id"  placeholder="<?= display('patient_id') ?>" name="patient_id" id="patient_id" class="form-control" value="<?php echo $user->patient_id; ?>"> 
			<span class="glyphicon glyphicon-user form-control-feedback"></span>
		</div>
		<div class="form-group has-feedback">
			<input type="password" placeholder="<?= display('phone') ?>" name="phone" id="phone" class="form-control" "> 
