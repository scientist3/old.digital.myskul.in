...
class Message extends CI_Controller {
    ...
    public function index($sender_id =null)
    {
        ...
        $data['content']  = $this->load->view('dashboard_org/messages/inbox' ,$data,true);
    ...
    public function reply($receiver_id = null){
		...
		redirect('dashboard_org//message/new_message');
	}
    ...
    public function sent($receiver_id =null)
	{
		...
		$data['content'] = $this->load->view('dashboard_org/messages/sent' ,$data,true);
		$this->load->view('dashboard_org/layout/main_wrapper_lte',$data);
	} 
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_org/messages/inbox_information',$data,true);
        $this->load->view('dashboard_org/layout/main_wrapper_lte',$data);
    }
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_org/messages/sent_information',$data,true);
        $this->load->view('dashboard_org/layout/main_wrapper_lte',$data);
    }
    ...
    { 
        ...
        if ($this->form_validation->run() === true) { 
            ...
            // die();
            $data['user_list'] = $this->user_model->read_by_role_as_list_for_message(null,$this->user_id,$this->organisation->org_id);
            $data['content'] = $this->load->view('dashboard_org/messages/new_message',$data,true);
            $this->load->view('dashboard_org/layout/main_wrapper_lte',$data);
        }  
    }
     ...
     public function user_by_role()
    {
        ...
        return $this->user_model->user_by_role_as_list($user_role,$this->user_id,$this->organisation->org_id);
    }
}
