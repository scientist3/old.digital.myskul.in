...
class Message extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
            'dashboard_nadu/messages/message_model' 
		));
    ...
    public function index()
    {
        ...
        $data['content']  = $this->load->view('dashboard_nadu/messages/inbox' ,$data,true);
	...
	public function sent()
	{
		...
		$data['content'] = $this->load->view('dashboard_nadu/messages/sent' ,$data,true);
		$this->load->view('dashboard_nadu/main_wrapper',$data);
	} 
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_nadu/messages/inbox_information',$data,true);
        $this->load->view('dashboard_nadu/main_wrapper',$data);
    }
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_nadu/messages/sent_information',$data,true);
        $this->load->view('dashboard_nadu/main_wrapper',$data);
    }
    ...
    { 
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_nadu/messages/message/new_message');
        } else {
            $data['title'] = display('new_message');
            $data['user_list'] = $this->message_model->user_list($user_id);
            $data['content'] = $this->load->view('dashboard_nadu/messages/new_message',$data,true);
            $this->load->view('dashboard_nadu/main_wrapper',$data);
        }  
    }
