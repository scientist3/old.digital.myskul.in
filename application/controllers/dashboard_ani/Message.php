...
class Message extends CI_Controller {
    ...
    public function index($sender_id =null)
    {
        ...
        $data['content']  = $this->load->view('dashboard_ani/messages/inbox' ,$data,true);
    ...
    public function reply($receiver_id = null){
		...
		redirect('dashboard_ani/message/new_message');
	}
    ...
    public function sent($receiver_id =null)
	{
		...
		$data['content'] = $this->load->view('dashboard_ani/messages/sent' ,$data,true);
		$this->load->view('dashboard_ani/layout/main_wrapper_lte',$data);
	} 
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_ani/messages/inbox_information',$data,true);
        $this->load->view('dashboard_ani/layout/main_wrapper_lte',$data);
    }
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_ani/messages/sent_information',$data,true);
        $this->load->view('dashboard_ani/layout/main_wrapper_lte',$data);
    }
    ...
    { 
        ...
        if ($this->form_validation->run() === true) { 
            ...
            $data['content'] = $this->load->view('dashboard_ani/messages/new_message',$data,true);
            $this->load->view('dashboard_ani/layout/main_wrapper_lte',$data);
        }  
    }
