...
class Material extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->center = $this->user_model->read_std_center_id($this->user_id);

        if (count($this->center)==0) { 
	...
	public function index()
	{
		...
		#------------------------------------------------#
		$data['materials']  =$this->material_model->read(0,0,$this->center->center_id,$this->user_id);
		$data['content']  = $this->load->view('dashboard_std/material/list',$data,true);
	...
	public function view($mat_id='')
	{
		...
		$data['content']  = $this->load->view('dashboard_std/material/view',$data,true);
		$this->load->view('dashboard_std/layout/main_wrapper_lte',$data);
	}  
