...
class User extends CI_Controller {
	...
	public function members($value='')
	{
		...
		$data['users'] 			= $this->user_model->read_members();
		$data['content'] = $this->load->view('dashboard_admin/user/member',$data,true);
	...
	public function create_member($value='')
	{
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($postData['user_id'])) {
				...
				redirect('dashboard_admin/user/user_profile/' . $u_id);
			} else {
				...
				redirect('dashboard_admin/user/user_edit/'.$postData['user_id']);
			}
		} else {
			$data['content'] = $this->load->view('dashboard_admin/user/member_form',$data,true);
			$this->load->view('dashboard_admin/layout/main_wrapper_lte',$data);
		}
	}
    ...
    public function user_profile($user_id = null) { 
		...
		$data['content'] = $this->load->view('dashboard_admin/user/user_profile',$data,true);
		$this->load->view('dashboard_admin/layout/main_wrapper_lte',$data);
	}
	...
	public function user_delete($user_id = null) 
	{
		...
		redirect('dashboard_admin/user/members');
	}
	#-------------------- Student -------------------#
	public function index() { 
		...
		$data['user_role_list']	= $this->dashboard_model->get_user_roles();
		$data['district_list']	= $this->dashboard_model->district_list();
		$data['users'] 			= $this->user_model->read_students();
		
		$data['content'] = $this->load->view('dashboard_admin/user/user',$data,true);
		$this->load->view('dashboard_admin/layout/main_wrapper_lte',$data);
	}
	...
	public function create_student() {
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($postData['user_id'])) {
				...
				redirect('dashboard_admin/user/stdprofile/' . $std_id);
			} else {
				if ($this->user_model->update($postData)) {
					#set success message
					$this->session->set_flashdata('message', display('update_successfully'));
				...
				redirect('dashboard_admin/user/stdedit/'.$postData['user_id']);
			}
		} else {
			$data['content'] = $this->load->view('dashboard_admin/user/std_form',$data,true);
			$this->load->view('dashboard_admin/layout/main_wrapper_lte',$data);
		}	
	}
	...
	public function stdprofile($std_id='') {
		...
		$data['user_role_list']=$this->dashboard_model->get_user_roles();
		$data['student'] = $this->user_model->read_by_id($std_id);
		$data['content'] = $this->load->view('dashboard_admin/user/std_profile2',$data,true);
		$this->load->view('dashboard_admin/layout/main_wrapper_lte',$data);
	}
